...
**Step 1:** [Start a new repo on Github.](https://ericmkeen.github.io/esci_222_setup/#Create_your_first_repo) 

**Step 2:** [Clone your new repo onto your local machine.](https://ericmkeen.github.io/esci_222_setup/#Clone_your_repo)   
...
**Step 7:** In Terminal, add-commit-push these changes to your repo so that they are pushed back to your main branch online.  
...
**Step 19:** By editing and committing the changes to that `README` file, you have updated your repo. Make sure the local version of your repo is up-to-date by running `git pull` in your Terminal.  *Always* run `git pull` locally whenever you change anything about your repo on the Github website!  
